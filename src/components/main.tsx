import { Component, h, JSX, RefObject, createRef } from "preact"
        ...
        return (
            <div>
                ...
                <Header>
                    ...
                    <Button classes="ml-2 bg-white text-gray-800" handleClick={this.login}>
                        Sign up
                    </Button>
                </Header>
                <Section classes="mt-16">
                    <div class="w-6/12 py-24 px-32 flex flex-col justify-center">
                        <h2 class="text-5xl font-bold mb-5 text-gray-800">Make more healthy choices</h2>
                ...
                <Section>
                    <div class="w-6/12">
                        <img class="object-cover w-full p-16" src="/assets/graph.png" alt="" />
                    </div>
                    <div class="w-6/12 py-24 px-32 flex-col flex justify-center">
                        <h2 class="text-5xl font-bold mb-5 text-gray-800">Get insights into your life</h2>
                        <p class="text-3xl text-gray-700">
